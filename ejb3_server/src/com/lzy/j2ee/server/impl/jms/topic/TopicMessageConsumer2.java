...
/**
 * Created by laizhiyuamn on 2017/8/13.
 *
 ...
 *
 *  name:是这个MDB在Jboss容器的JNDI，这里没有定义
...
@MessageDriven(
        ...
        activationConfig = {
                ...
                @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
                @ActivationConfigProperty(propertyName = "clientId", propertyValue = "my_topic_2"),
                @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "my_topic_2"),
...
public class TopicMessageConsumer2 implements MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            Thread.sleep(20000);
            System.out.println("=============> 我是Topic的2号消费者，我收到消息：" + textMessage.getText());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
