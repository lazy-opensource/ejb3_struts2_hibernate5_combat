 ...
 *
 * name:是这个MDB在Jboss容器的JNDI，这里就没有定义这个
...
public class P2pMessageConsumer2 implements MessageListener {


    public P2pMessageConsumer2() {
        super();
    }
    ...
    public void onMessage(Message msg) {
        ...
        try {
            Thread.sleep(20000);
            System.out.println("=============> 我是P2P的2号消费者，我收到消息：" + textMessage.getText());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
