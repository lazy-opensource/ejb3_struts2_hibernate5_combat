package com.lzy.j2ee.client.action.testremote;
 ...
 */
public class TestStatelessSessionRemoteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            */
            ...
            String jndi = "ejb:" + appName + "/" + moduleName + "/" + distinctName + "/"+ Constant.StatelessSessionRemote +"!" + viewClassName;

            /**
             * 注意远程调用使用remoteByJndi方法
             */
