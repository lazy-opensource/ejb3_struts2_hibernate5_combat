package com.lzy.j2ee.client.utils;
...
public class EjbHelper {
    ...
    /*发送JMS消息*/
    public static void sendJmsMessage(String destinationStr, String message){
    ...
    /*拼接出无状态会话Bean的JNDI*/
    public static String getJndi(Class interfaceClazz, String beanName){
        String appName = "";
    ...
    /*拼接出有状态会话Bean的JNDI*/
    public static String getStatefulJndi(Class interfaceClazz, String beanName){
        String appName = "";
        String moduleName = "ejb3_server";
        String distinctName = "";
        String viewClassName = interfaceClazz.getName();
    ...
    public static Object localByJndi(String jndi){
        Context context;
    ...
    public static Object remoteByJndi(String jndi){
